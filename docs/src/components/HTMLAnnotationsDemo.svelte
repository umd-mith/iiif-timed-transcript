...
<div class="w-full html-annotations-demo">
...
<style>
  ...
  :global(.html-annotations-demo .transcript-panel) {
    @apply flex-1 flex flex-col overflow-y-auto;
  }

  :global(.html-annotations-demo .segments-container) {
    @apply p-4;
  }

  /* Prominent search bar styling */
  :global(.html-annotations-demo input[type="search"]) {
