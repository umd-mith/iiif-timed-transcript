...
describe('annotationUtils', () => {
	...
	describe('getActiveAnnotation', () => {
		...
		it('handles single annotation', () => {
			const single: Annotation[] = [{ id: 'only', startTime: 10, endTime: 20, text: 'Only one' }];
	...
	describe('scrollProgressToTime', () => {
		...
		it('handles single annotation', () => {
			const single: Annotation[] = [{ id: 'only', startTime: 10, endTime: 20, text: 'Only' }];
		...
		it('handles annotation without endTime gracefully (should not happen)', () => {
			const broken: any[] = [{ id: 'broken', startTime: 0, text: 'No end time' }];
